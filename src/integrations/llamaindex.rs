...
use crate::framework_common::{self, FrameworkCollection};
...
impl NeedleVectorStoreIndex {
    ...
    pub fn query_with_filter(
        ...
        let results = self.collection.search(query_embedding, top_k, filter)?;
        ...
        let nodes: Vec<NodeWithScore> = results
            ...
            .filter_map(|result| {
                ...
                let score = framework_common::distance_to_score(
                    result.distance,
