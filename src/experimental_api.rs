...
pub use crate::adaptive_index::{
    ...
    IndexStrategy, MigrationEvent, SearchExplanation, WorkloadProfile as AdaptiveWorkloadProfile,
};
#[cfg(feature = "experimental")]
pub use crate::adaptive_runtime::{
    ActiveIndexType, AdaptiveRuntime, AdaptiveRuntimeConfig, MigrationPhase, MigrationPolicy,
    OperationType as AdaptiveOperationType, RuntimeHealth, SelectionReason, WorkloadClassifier,
    WorkloadSample,
};
#[cfg(feature = "experimental")]
pub use crate::adaptive_service::{
    AdaptiveIndexService, AdaptiveServiceConfig, AdaptiveServiceConfigBuilder, AdaptiveStatusReport,
};
#[cfg(feature = "experimental")]
pub use crate::agentic_memory::{
    AgentMemory, ContextSection, ContextWindowManager, ConversationConfig, ConversationRole,
    ConversationTracker, ConversationTurn, DecayFunction as AgentDecayFunction, Memory,
    MemoryConfig, MemoryType, RecallResult, ToolCallCache, ToolCallCacheStats,
};
#[cfg(feature = "experimental")]
pub use crate::analytics::{
    generate_dashboard_html, Alert, AlertCondition, AlertManager, AlertRule, AlertSeverity,
    AnalyticsConfig, AnalyticsDashboard, CollectionAnalytics, DashboardInsights, MetricsStore,
    QueryEvent, QueryPattern, QueryTracker, SlowQuery, TimeSeries, TimeSeriesPoint,
};
...
pub use crate::cloud_storage::{
    AzureBlobBackend, AzureBlobConfig, CacheConfig, CachedBackend, GCSBackend, GCSConfig,
    LocalBackend, RetryPolicy, S3Backend, S3Config, StorageBackend, StorageConfig,
};
#[cfg(feature = "experimental")]
...
pub use crate::edge_optimized::{
    ...
    EdgeRuntimeStats as EdgeOptRuntimeStats, EdgeSearchResult as EdgeOptSearchResult,
    InMemoryPersistence, OfflineCacheConfig, OfflineSearchCache,
    PartitionConfig as EdgePartitionConfig, PartitionManifest as EdgeOptPartitionManifest,
    PlatformLimits,
};
#[cfg(feature = "experimental")]
...
pub use crate::embeddings_gateway::{
    BatchEmbeddingResult, EmbeddingResult, EmbeddingsGateway, GatewayConfig, GatewayMetrics,
    ProviderConfig, ProviderMetrics, ProviderRouter, ProviderStatus, ProviderType,
    RoutingStrategy as GatewayRoutingStrategy, SemanticCache,
};
...
#[cfg(feature = "experimental")]
pub use crate::experimental::edge_runtime::{
    EdgeCacheConfig, EdgeConfig, EdgeHnswConfig, EdgeManifest, EdgeRuntime, EdgeRuntimeStats,
    EdgeStorage, InMemoryEdgeStorage, IndexSegment, Platform, SearchCache, SegmentMetadata,
};
pub use crate::federated::{
    ConsistencyLevel as FederatedConsistencyLevel, CrossInstanceDedup, DedupStrategy,
    DiscoveryConfig, DiscoveryService, FederatedSearchResponse, FederatedSearchResult, Federation,
    FederationConfig, FederationError, FederationHealth, FederationResult, HealthCheckResult,
    HealthMonitor, HealthStatus, InstanceConfig, InstanceInfo, InstanceRegistry, MergeStrategy,
    QueryPlan as FederatedQueryPlan, QueryPlanner as FederatedQueryPlanner, ResultMerger,
    RoutingStrategy,
};
...
pub use crate::graphrag_index::{
    EntityCategory, EntityExtractor, EntityPattern, ExtractedEntity, ExtractedRelation,
    ExtractionConfig, GraphEdge as GraphRagEdge, GraphNode, GraphRagConfig, GraphRagIndex,
...
pub use crate::ingestion_pipeline::{
    BackpressureState as PipelineBackpressureState, Checkpoint, CheckpointStore, DeadLetterQueue,
    FailedRecord, IdentityTransform, InMemoryCheckpointStore, InMemorySink, InMemorySource,
    IngestionPipeline, PipelineBuilder, PipelineConfig, PipelineStats, Record, RecordData,
    RetryPolicy as PipelineRetryPolicy, Sink, Source, TextToVectorTransform, Transform,
};
...
pub use crate::langchain::{
    CollectionStats as LangChainCollectionStats, Document, DocumentWithScore, FilterBuilder,
    NeedleVectorStore, NeedleVectorStoreConfig, RelevanceScoreFunction,
};
#[cfg(feature = "experimental")]
...
pub use crate::llamaindex::{
    ...
    MemoryConfig as ConversationMemoryConfig, MessageRole, NeedleIndexConfig,
    NeedleVectorStoreIndex, NodeRelationship, NodeWithScore, RelatedNode, RetrieverQueryEngine,
    TextNode,
};
#[cfg(feature = "experimental")]
...
pub use crate::local_inference::{
    builtin_model_registry, find_model, CachedModel, InferenceConfig, InferenceEngine,
    InferenceStats, ModelCache, ModelQuantization, ModelSource, ModelSpec, SimpleTokenizer,
};
...
pub use crate::matryoshka::{
    MatryoshkaConfig, MatryoshkaEmbedding, MatryoshkaIndex, MatryoshkaStats,
    SearchStrategy as MatryoshkaSearchStrategy,
};
pub use crate::migrations::{
    built_in_migrations, CompatibilityResult, IndexType as MigrationIndexType, IssueSeverity,
    Migration, MigrationContext, MigrationError, MigrationManager, MigrationOperation,
    MigrationPreview, MigrationRecord, MigrationResult, MigrationStatus as SchemaMigrationStatus,
    SchemaVersion, ValidationIssue,
};
...
pub use crate::multimodal_index::{
    FusionStrategy as MultiModalFusionStrategy, Modality as MultiModalModality, ModalityConfig,
    MultiModalDoc, MultiModalDocBuilder, MultiModalIndexConfig,
    MultiModalSearchResult as UnifiedMultiModalSearchResult,
    MultiModalStats as UnifiedMultiModalStats, MultiModalUnifiedIndex as UnifiedMultiModal,
};
...
pub use crate::nl_filter::{
    ContextEntry, ConversationContext, ConversationalQueryParser, Entity as NLEntity,
    IntentClassification, NLFilterParser, ParsedQuery, QueryBuilder as NLQueryBuilder, QueryIntent,
    QuerySuggester, TemporalConstraint,
};
#[cfg(feature = "experimental")]
pub use crate::optimizer::{
    AdaptiveOptimizer, CollectionStatistics as OptimizerCollectionStatistics,
    CostEstimate as OptimizerCostEstimate, CostModel, FeedbackCollector,
...
pub use crate::pitr_service::{
    PitrService, PitrServiceConfig, PitrServiceConfigBuilder, PitrStats, RecoveryResult,
    RecoveryTarget, RestorePoint as PitrRestorePoint,
};
#[cfg(feature = "experimental")]
pub use crate::platform_adapters::{
    ChunkedEdgeStorage, CloudflareKvAdapter, CloudflareR2Adapter, DenoKvAdapter, TieredEdgeStorage,
    VercelBlobAdapter, VercelEdgeConfigAdapter,
};
#[cfg(feature = "experimental")]
pub use crate::playground::{
    generate_playground_html, Bookmark, ClusterInfo, CustomDataset, Dataset, DatasetInfo,
    Difficulty, ExecutionResult, HistoryEntry, Playground, PlaygroundConfig, PlaygroundState,
...
pub use crate::plugin_registry::{
    ...
    PluginRegistry as PluginMarketplace, PluginRuntimeManager, PluginStatus, PostSearchHookFn,
    PreSearchHookFn, PublishedPlugin, RegistryConfig as MarketplaceConfig, RegistryPluginType,
    ThresholdFilter, TransformFn, TruncateTransform,
};
#[cfg(feature = "experimental")]
pub use crate::plugin_runtime::{
    HookInfo as PluginHookInfo, PluginHook, PluginRuntime, PluginRuntimeConfig,
...
pub use crate::python_arrow::{
    ...
    CollectionInfo as PythonCollectionInfo, DatabaseInfo as PythonDatabaseInfo, MemoryOrder,
    OperationStats, PythonSearchResult, TypedValue, VectorArrayView,
};
...
pub use crate::query_explain::{
    AdaptiveEfTuner, CostModel as ExplainCostModel, CostModelParams, ExplainPlan, ExplainStrategy,
    FilterMode, OptimizerConfig as ExplainOptimizerConfig, OptimizerStats as ExplainOptimizerStats,
...
pub use crate::query_planner::{
    CollectionStats as PlannerCollectionStats, PlanStep as PlannerStep, PlanStrategy,
    QueryPlan as PlannerQueryPlan, QueryPlanner, QueryPlannerConfig,
    QueryRequest as PlannerQueryRequest,
};
pub use crate::raft::{Command, NodeId, RaftConfig, RaftNode, RaftState, RaftStorage};
pub use crate::rag::{
    quick_rag_pipeline, Chunk, ChunkingStrategy, RagConfig, RagPipeline, RagPipelineBuilder,
};
...
pub use crate::security::{
    AccessControl as SecurityAccessControl, AccessController, AuditAction, AuditEvent, AuditLogger,
    AuditQuery, AuditResult, FileAuditLog, FileAuditLogConfig, InMemoryAuditLog, Permission,
    PermissionGrant, PolicyDecision, Resource, Role, SecurityContext, User,
};
pub use crate::semantic_kernel::{MemoryQueryResult, MemoryRecord, NeedleMemoryStore};
pub use crate::shard::{
    merge_shard_results, CrossShardSearchConfig, CrossShardSearchResult, ShardConfig, ShardError,
    ShardId, ShardInfo, ShardManager, ShardSearchResult, ShardSearchable, ShardState,
    ShardedCollection,
};
pub use crate::snapshot_replication::{
    compute_replication_health, CompressionType, DeltaOperation, FollowerInfo, FollowerSyncStatus,
    InMemoryTransport, ReplicationConfig as SnapshotReplicationConfig, ReplicationFollower,
    ReplicationHealth, ReplicationLeaderNode, Snapshot as ReplicationSnapshot, SnapshotDelta,
    SnapshotTransport, SnapshotType, WalReplicationEntry,
};
#[cfg(feature = "experimental")]
pub use crate::streaming_upsert::{
    ArrowVectorBatch, BackpressureGate, BatchInsertResult as StreamingBatchInsertResult, Frame,
    FrameType, IngestionEngine, IngestionEngineConfig, IngestionMetrics, PressureLevel,
    StreamingUpsertConfig, StreamingUpsertConfigBuilder, ThroughputTracker, UpsertPipeline,
    UpsertStats, VectorBatch as StreamingVectorBatch, VectorBatchBuilder, VectorRecord,
};
...
pub use crate::tenant_isolation::{
    ...
    ExportFormat as TenantExportFormat, GdprExport, MeteringConfig, Permission as TenantPermission,
    ResourceUsage, Tenant as IsolatedTenant, TenantConfig as TenantIsolationConfig, TenantId,
    TenantManager, TenantRateLimiter, TenantRole, TenantStatus as IsolatedTenantStatus,
    UsageEvent as TenantUsageEvent, UsageEventKind, UsageMeter,
};
...
pub use crate::tiered::{
    StorageTier, TierPolicy, TieredStorage, VectorMetadata as TieredVectorMetadata,
};
#[cfg(feature = "diskann")]
pub use crate::tiered_ann::{
    Tier, TieredConfig, TieredIndex, TieredQueryBuilder, TieredSearchResult, TieredStats,
};
pub use crate::tiered_service::{
    MaintenanceReport, Tier as ServiceTier, TierPolicy as ServiceTierPolicy, TieredService,
    TieredServiceConfig, TieredServiceConfigBuilder, TieredServiceStats,
};
...
pub use crate::transaction::{
    IsolationLevel, SnapshotView, Transaction, TransactionId, TransactionLog, TransactionManager,
    TransactionStats, TransactionStatus, WriteOperation,
};
#[cfg(feature = "experimental")]
pub use crate::vector_streaming::{
    BackpressureConfig, BackpressureController, BackpressureState, BackpressureStats, CdcEvent,
    CdcEventType, CdcStream, ConsumerConfig, ConsumerStats, MessageSource, ProducerConfig,
    ProducerStats, ReplayManager, StreamMetrics, StreamMetricsSnapshot, StreamOp, StreamProcessor,
    StreamSnapshot, VectorConsumer, VectorFormat, VectorMessage, VectorProducer,
    VectorStreamPipeline,
};
