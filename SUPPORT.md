...
- **[How-To Guides](docs/how-to-guides.md)** — Task-oriented guides
...
See the [Index Selection Guide](docs/index-selection-guide.md) or use `auto_tune()` for automatic recommendations.
...
Needle is pre-1.0 (currently v0.1.x). Core features are stable, but the API may change between minor versions. See [API Stability](docs/api-stability.md) for tier definitions.
